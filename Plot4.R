...
par(mfrow=c(2,2))
##Plot the 1st graph;
with(newdata, plot(d, Global_active_power, xlab="", ylab="Global active power", type="l", main=("")))

##Plot the 2nd graph;
with(newdata, plot(d, Voltage, xlab="datetime", ylab="Voltage", type="l", main=("")))

##Plot the 3rd graph, start with the "Sub_metering_1" variable Without showing the line;
